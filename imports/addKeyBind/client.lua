if supv.cache.game == 'redm' then return end
...
local IsPauseMenuActive <const> = IsPauseMenuActive
local GetControlInstructionalButton <const> = GetControlInstructionalButton
