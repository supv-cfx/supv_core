...
require('imports.on.client').net('supv_core:SetVehiclesProperties', function(netId, properties)
    local timeout = 100
...
require('imports.callback.client').register('supv_core:GetVehiclesProperties', function(netId, filter)
    local timeout = 100
    while not NetworkDoesEntityExistWithNetworkId(netId) and timeout > 0 do
        Wait(0)
        timeout -= 1
